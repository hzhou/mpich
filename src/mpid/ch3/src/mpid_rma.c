...
static int win_init(MPI_Aint size, MPI_Aint disp_unit, int create_flavor, int model, MPIR_Info * info,
...
int MPID_Win_shared_query(MPIR_Win * win, int rank, MPI_Aint * size, MPI_Aint *disp_unit, void *baseptr)
{
    int mpi_errno = MPI_SUCCESS;
